...
trialLimit = 10 #number of trials- change as needed
trialSleepTime = 5 # feed consumption time-change as needed
mode = 'test'
if mode == 'test':
    trialLimit = 3
    trialSleepTime = 1
        ...
        if green_button.is_pressed():
            ...
            if green_button_press_count == 1:
                ...
                while touch_count < trialLimit:
                    ...
                    # waiting for either a touch or blue button press
                    while True:
                        ...
                        if blue_button.is_pressed():
                            # manual override-trial now under manual control until end
                            if start_tone_played == True:
                                ...
                                time.sleep(0.5)
                                feeder_grain.dispense_feed_grain() # change feeder pbject if using pellets
